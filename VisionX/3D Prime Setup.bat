...
reg.exe add "%LAYERS%" /v "C:\ProgramData\Air Techniques\VisionX\WorkstationService\VistaVoxPlugin\Acquisition\CBCT\WidePano\VAKCAP.exe" /t REG_SZ /d "~ RUNASADMIN" /f
reg.exe add "%LAYERS%" /v "C:\ProgramData\Air Techniques\VisionX\WorkstationService\VistaVoxPlugin\Acquisition\CBCT\WidePano\VAKPAR_CTG.exe" /t REG_SZ /d "~ RUNASADMIN" /f
reg.exe add "%LAYERS%" /v "C:\ProgramData\Air Techniques\VisionX\WorkstationService\VistaVoxPlugin\Acquisition\CBCT\WidePano\VAKPAR_FTG.exe" /t REG_SZ /d "~ RUNASADMIN" /f

reg.exe add "%LAYERS%" /v "C:\ProgramData\Air Techniques\VisionX\WorkstationService\VistaVoxPlugin\Acquisition\Ceph\WideCeph\VAKCAP.exe" /t REG_SZ /d "~ RUNASADMIN" /f
reg.exe add "%LAYERS%" /v "C:\ProgramData\Air Techniques\VisionX\WorkstationService\VistaVoxPlugin\Acquisition\Ceph\WideCeph\VAPAN_FTG.exe" /t REG_SZ /d "~ RUNASADMIN" /f

reg.exe add "%LAYERS%" /v "C:\ProgramData\Air Techniques\VisionX\WorkstationService\VistaVoxPlugin\Acquisition\Pano\WidePano\VAKCAP.exe" /t REG_SZ /d "~ RUNASADMIN" /f
reg.exe add "%LAYERS%" /v "C:\ProgramData\Air Techniques\VisionX\WorkstationService\VistaVoxPlugin\Acquisition\Pano\WidePano\VAPAN_CTG.exe" /t REG_SZ /d "~ RUNASADMIN" /f
reg.exe add "%LAYERS%" /v "C:\ProgramData\Air Techniques\VisionX\WorkstationService\VistaVoxPlugin\Acquisition\Pano\WidePano\VAPAN_FTG.exe" /t REG_SZ /d "~ RUNASADMIN" /f
